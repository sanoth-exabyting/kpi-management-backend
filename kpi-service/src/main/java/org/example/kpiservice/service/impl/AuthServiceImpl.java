...
public class AuthServiceImpl implements AuthService {
    ...
    public RegisterResponse register(RegisterRequest request) {
        ...
        if (secondaryEmployeeOpt.isEmpty()) {
            throw RequestValidationException.from(HttpStatus.BAD_REQUEST,
                    "Email not found in employee records. Please contact HR.");
        }
        ...
        if (existingEmployee.isPresent()) {
            throw RequestValidationException.from(HttpStatus.CONFLICT,
